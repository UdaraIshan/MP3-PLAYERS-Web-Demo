...
<body>
  ...
  <div class="top">
    ...
    <div class="header">
      ...
      <h1 class="title-txt"> Taple Gen Z's </h1>
    </div>

    <div class="main-area">
      <div class="about-item">
        <p class="txt">The Taple Gen Z's is a premium Walkman designed for optimal sound quality. Feel every note and nuance
      ...
      <div class="item-image">
        <img class="product" src="images/gen z.jpg" alt="Taple Gen Z's">
      </div>
    </div>
