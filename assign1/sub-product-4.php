...
<head>
  ...
  <link rel="stylesheet" href="styles/sub-product-4.css">
</head>
...
<body>
  ...
  <div class="top">
    ...
    <div class="header">
      <img class="logo" src="images/taple..jpeg" alt="Taple logo">
      <h1 class="title-txt"> Taple Classic </h1>
    </div>

    <div class="main-area">
      <div class="about-item">
        <p class="txt">The Taple Classic is a premium Walkman designed for optimal sound quality. Feel every note and nuance
      ...
      <div class="item-image">
        <img class="product" src="images/taple classic.jpg" alt="Taple Classic">
      </div>
    </div>

    <p class="txt">Taple is committed not only to offering products, services and content that deliver exciting
