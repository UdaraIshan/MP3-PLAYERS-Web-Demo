...
<body>
  ...
  <div class="top">
    ...
    <div class="header">
      ...
      <h1 class="title-txt"> XY7R - LK ver. </h1>
    </div>

    <div class="main-area">
      <div class="about-item">
        <p class="txt">The XY7R - LK ver. is a premium Walkman designed for optimal sound quality. Feel every note and nuance
      ...
      <div class="item-image">
        <img class="product" src="images/mp3.jpg" alt="XY7R - LK ver.">
      </div>
    </div>
