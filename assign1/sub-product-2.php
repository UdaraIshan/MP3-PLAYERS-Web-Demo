...
<body>
  ...
  <div class="top">
    ...
    <div class="header">
      ...
      <h1 class="title-txt"> AN - 4 Global </h1>
    </div>

    <div class="main-area">
      <div class="about-item">
        <p class="txt">The AN - 4 Global is a premium Walkman designed for optimal sound quality. Feel every note and nuance
      ...
      <div class="item-image">
        <img class="product" src="images/AN - 4.jpg" alt="AN - 4 Global">
      </div>
    </div>
