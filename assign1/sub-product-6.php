...
<body>
  ...
  <div class="top">
    ...
    <div class="header">
      ...
      <h1 class="title-txt"> Taple NW-02 </h1>
    </div>

    <div class="main-area">
      <div class="about-item">
        <p class="txt">The Taple NW-02 is a premium Walkman designed for optimal sound quality. Feel every note and nuance
      ...
      <div class="item-image">
        <img class="product" src="images/NW 2.jpg" alt="Taple NW-02">
      </div>
    </div>
